...
void mul(stack_t **sp);
void nop(stack_t **sp);
void pall(stack_t **sp);
void pchar(stack_t **sp);
void pint(stack_t **sp);
void pop(stack_t **sp);
void pstr(stack_t **sp);
void push(stack_t **sp);
void queue(stack_t **sp);
void rotl(stack_t **sp);
void rotr(stack_t **sp);
void stack(stack_t **sp);
void sub(stack_t **sp);
void swap(stack_t **sp);
